...
public class libraryController {
	...
	public String bookDetail(@RequestParam(value="bookId") int bookId, Model model) throws Exception{
	...
	public String myLoans(HttpServletRequest request, Model model, BookVO bookVO) throws Exception{
		HttpSession session = request.getSession();
		LoginVO loginVO = (LoginVO) session.getAttribute("loginVO");
	...
	public String loanList(HttpServletRequest request, Model model, BookVO bookVO) throws Exception{
		HttpSession session = request.getSession();
		LoginVO loginVO = (LoginVO) session.getAttribute("loginVO");
